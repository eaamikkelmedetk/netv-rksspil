...
public class Main2 extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			me = new Player("Mikkel", 4, 4, "up");
			addNewPlayer(me);

			sendCommand(
					"addPlayer " + me.getName() + " " + me.getXpos() + " " + me.getYpos() + " " + me.getDirection());
	...
	public void recieveAnswer() throws IOException {
	...
	public void handleResponse(String response) {
		...
		} else if (response.equals("PlayerMoves")) {
			String playerName = in.next();
			Player player = getPlayer(playerName);
			int xPos = in.nextInt();
			int yPos = in.nextInt();
			String direction = in.next();
			playerMoved(player, xPos, yPos, direction);
		}
	}
